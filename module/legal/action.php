...
if($act == 'create'){
  ...
  $is_public    = $_POST['is_sent'] == true ? 1:0;
  $is_delete    = 0;
  $us_approve   = '';
  $approve_date = '';
  $createdBy    = $user;
  ...
  $sql="INSERT INTO legal (id_project,flow,filename,slug,extension,link_doc,doc_number,doc_date,doc_title,doc_author,doc_recepient,doc_body,is_public,is_sent,is_delete,us_approve,approve_date,created_by,created_at,updated_by,updated_at)VALUES(NULL,'$flow','$fileName','$slug','$extension','$link_doc','$docNumb','$docDate','$docTitle','$docAuthor',
