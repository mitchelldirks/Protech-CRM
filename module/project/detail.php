  ...
  <div class="col-md-12 ">
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if (strlen($detail['url'])>0): ?>
          <p>URL Project <a href="<?php echo $detail['url'] ?>" target="_blank"><?php echo $detail['url'] ?></a></p>
        <?php endif ?>
        <?php if ($_SESSION['level'] == 'admin'): ?>
          <p><small>Signature <b title="Only admin who can view this"><?php echo $detail['signature'] ?></b></small></p>
        <?php endif ?>
