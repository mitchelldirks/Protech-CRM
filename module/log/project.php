...
$project=mysqli_fetch_array(mysqli_query($conn,"SELECT * from project where signature = '".$_GET['signature']."'"));
$query = mysqli_query($conn, "SELECT * FROM project join log_external on project.signature=log_external.signature where log_external.signature = '".$_GET['signature']."' ORDER BY timestamp desc");
